  ...
  var productShow = function (n) {
      return function (v) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
              ...
              if (template_ instanceof Data_Maybe.Nothing) {
                  return CustomEvent.err(CustomEvent.elemNotFound("product-template"))();
              };
              throw new Error("Failed pattern match at ProductShow (line 28, column 3 - line 34, column 60): " + [ box_.constructor.name, template_.constructor.name ]);
          });
      };
  };
